...
with C#, I probably would have guessed "8-10x more features/hour."
...
crowd gathers, some to cheer, others to sneer.

The issue with programming tools is that you need faith. No real research exists
around language productivity. Without science, only faith remains.

The other day, I went back to add features to a personal Clojure project. I
wrote this project to be the paragon of beauty. High unit test coverage,
carefully designed WebDriver tests, bi-directional migration scripts, and a
makefile to automate every task.

I went to add a new feature that I estimated would take a few hours. Nine hours
later, I felt the crushing weight of defeat. 
